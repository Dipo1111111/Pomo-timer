...
const styles: Record<string, React.CSSProperties> = {
  ...
  headerTop: {
    ...
    fontSize: 13, fontStyle: 'italic', color: '#8B1A2A',
    letterSpacing: 1, marginBottom: 4,
  },
  divider: { width: 40, height: 1, background: '#8B1A2A', margin: '0 auto 24px', opacity: 0.4 },
  sessionLine: {
    fontSize: 11, letterSpacing: 3, textTransform: 'uppercase' as const,
    color: '#2C2520', opacity: 0.35,
  },
  timerSection: {
  ...
  timeDigits: {
    fontFamily: "'Cormorant Garamond', Georgia, serif",
    fontSize: 52, fontWeight: 500, color: '#2C2520',
    letterSpacing: 0, lineHeight: 1,
  },
  timeColon: { color: '#8B1A2A', opacity: 0.6, margin: '0 2px' },
  durationLabel: {
    fontSize: 11, letterSpacing: 2, textTransform: 'uppercase' as const,
    color: '#2C2520', opacity: 0.35, marginTop: 10,
  },
  sessionRoman: {
    fontFamily: "'Cormorant Garamond', Georgia, serif",
    fontSize: 14, fontStyle: 'italic', color: '#8B1A2A',
    marginTop: 8,
  },
  dividerWide: {
    width: '100%', height: 1, background: '#2C2520',
  ...
  btnGhost: {
    border: '1.5px solid transparent', color: '#2C2520', opacity: 0.4,
  },
    ...
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        <div style={styles.timerSection}>
          <div style={styles.ringWrapper}>
            ...
            <svg width="100%" height="100%" viewBox="0 0 220 220" style={{ transform: 'rotate(-90deg)' }}>
              <circle cx="110" cy="110" r="95" fill="none" stroke="#2C2520" strokeWidth="1" opacity="0.08" />
              <circle cx="110" cy="110" r="95" fill="none" stroke="#8B1A2A" strokeWidth="2"
              ...
              <circle cx="110" cy="15" r="2" fill="#8B1A2A" opacity="0.6" />
            </svg>
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{
            fontFamily: "'Cormorant Garamond', Georgia, serif",
            fontSize: 14, fontStyle: 'italic', color: '#8B1A2A', marginTop: 4,
          }}>short respite</div>
        </div>
